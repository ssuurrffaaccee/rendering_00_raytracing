...
int main() {
  try {
    ...
    HittableList world;
    // world.add(
    //     make_sphere(Point3(-0.5, 0, -1), 0.5,
    //     make_metal_material(Color{0.8f,0.8f,1.0f})));
    // world.add(
    //     make_sphere(Point3(0.5, 0, -1), 0.5,
    //     make_lambertian_material(Color{0.8f,0.8f,1.0f})));
    world.add(make_sphere(Point3(-0.5, 0, -1), 0.5,
                          make_metal_material(Color{1.0f, 0.0f, 0.0f})));
    world.add(make_sphere(Point3(0.5, 0, -1), 0.5,
                          make_lambertian_material(Color{0.0f, 1.0f, 0.0f})));
    world.add(make_sphere(Point3(0, -100.5, -1), 100,
                          make_lambertian_material(Color{0.7, 0.3, 0.3})));

...
public:
  ...
  CheckerTexture(double scale, const Color &c1, const Color &c2)
      : inv_scale_{1.0 / scale}, even_(make_solid_color_texture(c1)),
...
public:
  ...
  UVViewTexture(double scale, const Color &c1, const Color &c2)
      : scale_{scale}, even_(make_solid_color_texture(c1)),
        odd_(make_solid_color_texture(c2)) {}
...
SPtr<Texture> make_noise_texture() {
  auto ptr = new NoiseTexture{};
  return SPtr<Texture>{(Texture *)ptr};
}
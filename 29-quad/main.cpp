...
int main() {
  try {
    ...
    int thread_num = 5;
    {
      HittableList world;
      // Materials
      auto left_red = make_lambertian_material(Color{1.0, 0.2, 0.2});
      auto back_green = make_lambertian_material(Color{0.2, 1.0, 0.2});
      auto right_blue = make_lambertian_material(Color{0.2, 0.2, 1.0});
      auto upper_orange = make_lambertian_material(Color{1.0, 0.5, 0.0});
      auto lower_teal = make_lambertian_material(Color{0.2, 0.8, 0.8});

      // Quads
      world.add(make_quad(Point3{-3, -2, 5}, Vec3{0, 0, -4}, Vec3{0, 4, 0},
                          left_red));
      world.add(make_quad(Point3{-2, -2, 0}, Vec3{4, 0, 0}, Vec3{0, 4, 0},
                          back_green));
      world.add(make_quad(Point3{3, -2, 1}, Vec3{0, 0, 4}, Vec3{0, 4, 0},
                          right_blue));
      world.add(make_quad(Point3{-2, 3, 1}, Vec3{4, 0, 0}, Vec3{0, 0, 4},
                          upper_orange));
      world.add(make_quad(Point3{-2, -3, 5}, Vec3{4, 0, 0}, Vec3{0, 0, -4},
                          lower_teal));

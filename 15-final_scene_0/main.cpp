...
int main() {
  try {
    ...
    HittableList world;
    {
      auto ground_material = make_lambertian_material(Color(0.5, 0.5, 0.5));
      world.add(make_sphere(Point3(0, -1000, 0), 1000, ground_material));
        ...
        for (int b = -11; b < 11; b++) {
          ...
          if ((center - Point3(4, 0.2, 0)).length() > 0.9) {
            ...
            if (choose_mat < 0.8) {
              ...
              world.add(make_sphere(center, 0.2, sphere_material));
      ...
      world.add(make_sphere(Point3(0, 1, 0), 1.0, material1));

      auto material2 = make_lambertian_material(Color(0.4, 0.2, 0.1));
      world.add(make_sphere(Point3(-4, 1, 0), 1.0, material2));

      auto material3 = make_metal_material(Color(0.7, 0.6, 0.5), 0.0);
      world.add(make_sphere(Point3(4, 1, 0), 1.0, material3));
    }

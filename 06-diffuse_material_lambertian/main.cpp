...
Color background_color(const Ray &ray) { // light is from here，background is the light source.
...
int main() {
  try {
    ...
    HittableList world;
    world.add(
        make_sphere(Point3(0, 0, -1), 0.5, make_lambertian_material(Color{0.8f,0.8f,1.0f})));
